package fr.kikori.ws.tableaux.ajoutsuppr.editable.model;
...
public class Beer {
    ...
    /**
     * is the beer still in production ?
     */
     ...
     * @param producedSince the produced since
     */
    public Beer(long id, String name, String brewer, String colour, BigDecimal abv, BigDecimal bottleSize, LocalDate producedSince, boolean inProduction) {
        this(id, name, brewer, colour, abv, bottleSize, producedSince);
